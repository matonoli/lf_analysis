...
void plotPtvNt_Nt() {
  ...
  TFile* fIn = new TFile(Form("%s/testout.root",path.Data()),"READ");
...
//   A2->Draw();
  ...
  latexTitleX->DrawLatex(0.90, 0.6, TitleX);
  ...
  C->SaveAs(Form("./PtvNt_Nt_%s.pdf",part.Data()));
  C->SaveAs(Form("./PtvNt_Nt_%s.png",part.Data()));
